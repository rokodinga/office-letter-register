  ...
  const makeHandbook = () => {
    ...
    sheets.forEach(sheet => {
      ...
      sheet.rows.forEach(row => {
        ...
        chunks.forEach((chunk: string) => { if (y > height - 14) { pdf.addPage(); y = 18; } pdf.text(chunk.slice(0, 180), 15, y); y += 3.7; });
      });
      y += 5;
    });
