...
import { ArrowDownToLine, ArrowUpFromLine, FileText, LogOut, Plus, Search, UserCircle } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Link to="/incoming" className="bg-blue-600 hover:bg-blue-700 rounded-xl shadow p-6 text-white transition">
            ...
            <h2 className="text-xl font-bold mt-5">Incoming Letters</h2><p className="text-blue-100 mt-1">View and register received correspondence</p>
          </Link>
          <Link to="/outgoing" className="bg-emerald-600 hover:bg-emerald-700 rounded-xl shadow p-6 text-white transition">
            ...
            <h2 className="text-xl font-bold mt-5">Outgoing Letters</h2><p className="text-emerald-100 mt-1">View and register dispatched correspondence</p>
          </Link>
          <div className="bg-purple-600 rounded-xl shadow p-6 text-white">
            ...
            <h2 className="text-xl font-bold mt-5">Total Records</h2><p className="text-purple-100 mt-1">All letters currently registered</p>
          </div>
        </div>
